...
export default function Home(){
 ...
 return <main>
  ...
  <section className="hero" id="top"><div><h1>좋아하는 세계를<br/><em>만나러 가는 날.</em></h1><p className="hero-copy">전국의 창작 콘텐츠 페어 일정을<br/>공식 출처에서 모아보세요.<span className="hero-credit">이 사이트는 작가 쭈유가 만들었습니다.</span></p></div></section>
